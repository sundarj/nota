...
},{"../bus":25,"../util":31,"./nota-editor.vue":28,"vue":22,"vue-hot-reload-api":20}],27:[function(require,module,exports){
;(function(){
'use strict';
...
exports.default = {
  ...
  methods: {
    ...
    getItemLocation: function getItemLocation(_ref6) {
      var _params;
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;return _vm._h('nav',{on:{"!click":function($event){_vm.edit( $event )},"keyup":function($event){_vm.keyup( $event )},"focusout":function($event){_vm.blur( $event )}}},[_vm._l((_vm.results),function(ref){
var type = ref.type;
var id = ref.id;
var parent = ref.parent;
var title = ref.title;
...
},{"../bus":25,"../util":31,"babel-runtime/helpers/defineProperty":2,"vue":22,"vue-hot-reload-api":20,"vueify/lib/insert-css":23}],30:[function(require,module,exports){
'use strict';
