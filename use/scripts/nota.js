...
},{"../bus":103,"./nota-editor.vue":105,"./nota-list.vue":106,"vue":99,"vue-hot-reload-api":98}],105:[function(require,module,exports){
...
},{"vue":99,"vue-hot-reload-api":98,"vueify/lib/insert-css":100}],106:[function(require,module,exports){
...
exports.default = {
  ...
  methods: {
    historychange: function historychange(location) {
      ...
      var _items$find = this.items.find(function (_ref3) {
        var id = _ref3.id;
        return id === params.id;
      });
      ...
      this.results = this.items.filter(function (_ref2) {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _h('nav',{staticAttrs:{"am-nota":"list"}},[(results)&&_l((results),function(item){return [(item.type === "nota")?_h('a',{directives:[{name:"href",value:({ name: "root", params: { id: item.id } }),expression:"{ name: \"root\", params: { id: item.id } }"}],staticAttrs:{"am-nota":"item"}},[_m(0)," ",_h('span',[_s(item.title)])]):_h('a',{directives:[{name:"href",value:({ name: "item", params: { id: item.id } }),expression:"{ name: \"item\", params: { id: item.id } }"}],staticAttrs:{"am-nota":"folder-title"}},[_h('span',{staticClass:"material-icons"},[" folder "])," ",_h('span',[_s(item.title)])])," "]})])}}
...
},{"../bus":103,"vue":99,"vue-hot-reload-api":98,"vueify/lib/insert-css":100}],107:[function(require,module,exports){
'use strict';
